...
export default {
  ...
  methods: {
    selectDeposito(e) {
      console.log(e.target[e.target.options.selectedIndex]);
      this.form.deposito_id = e.target[e.target.options.selectedIndex].value;
    },
    selectCategoria(e) {
      this.form.categoria_id = e.target[e.target.options.selectedIndex].value;
    },
